    ...
    public partial class user : UserControl
    {
        ...
        private void GirisYap_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                MessageBox.Show("You have entered an incorrect information. Please check your details.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                Yetki = dt.Rows[0]["Yetki"].ToString();
                if (Yetki == "Member" || Yetki == "Admin")
                {
                ...
                {
                    MessageBox.Show("Your membership may not have been activated. Please contact the authorities.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        }
    }
