...
namespace WindowsFormOdev.kutuphane
{
  public partial class kitapEkle : UserControl
  {
    ...
    void yeniler()
    {
      ...
      if (dtKitaplar.Columns.Count > 1) dtKitaplar.Columns[1].HeaderText = "Barcode";
      if (dtKitaplar.Columns.Count > 2) dtKitaplar.Columns[2].HeaderText = "Book Name";
      if (dtKitaplar.Columns.Count > 3) dtKitaplar.Columns[3].HeaderText = "Author";
      if (dtKitaplar.Columns.Count > 4) dtKitaplar.Columns[4].HeaderText = "Publisher";
      if (dtKitaplar.Columns.Count > 5) dtKitaplar.Columns[5].HeaderText = "Book Type";
      if (dtKitaplar.Columns.Count > 6) dtKitaplar.Columns[6].HeaderText = "Date";
      if (dtKitaplar.Columns.Count > 7) dtKitaplar.Columns[7].HeaderText = "Stock";
      if (dtKitaplar.Columns.Count > 8) dtKitaplar.Columns[8].HeaderText = "Damage";
    ...
    private void btnGetir_Click(object sender, EventArgs e)
    {
      ...
      if (kutuphane.Rows.Count == 0)
      {
        ...
        {
          MessageBox.Show("Barcode or Book Name Incorrect or Not Written. Please try again...", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
        else
        {
    ...
    private void btnEkle_Click(object sender, EventArgs e)
    {
      ...
      else
      {
        if (kodlar.KitapKontrol1(cmbKitapAdi.Text) == true)
        {
          ...
          {
            MessageBox.Show("The barcode code was added earlier.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
          }
          else
          {
        ...
        {
          MessageBox.Show("The book has been added earlier.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
      }
    }
